...
const closePaymentContainer = document.getElementById ("closePaymentContainer") as HTMLDivElement;
closePaymentContainer.style.display = "none";

setTimeout(() => {
  const simTitle = document.getElementById("simTitle") as HTMLDivElement;
  const loader = document.getElementById("loader") as HTMLDivElement;
  const simLoadCenter = document.getElementById("simLoadCenter") as HTMLDivElement;
